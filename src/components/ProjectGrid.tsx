  ...
  if (loading) {
    return (
      <div className="flex flex-col gap-6">
        {[1, 2].map((i) => (
          <div key={i} className="bg-[#e5e5e5] animate-pulse" style={{ height: '280px' }} />
        ))}
      </div>
    )
  }
    ...
    <div className="flex flex-col">
      {projects.map((project) => (
        ...
        >
          ...
          <div
            className="w-full bg-[#e5e5e5] flex items-center justify-center mb-6"
            style={{ height: '240px' }}
          >
          ...
          <div className="max-w-[640px]">
            ...
            {project.context && (
              <p
                className="text-sm text-[#525252] leading-relaxed mb-4"
